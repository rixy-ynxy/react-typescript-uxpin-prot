...
describe('serializeJSComponent', () => {
    describe('providing array of objects describing all properties of the JavaScript component', () => {
        it('serializes functional component with primitive property types', () => {
            // given
            const component = getImplementation_1.getImplementation('FunctionPrimitivesOnly');
        ...
        it('serializes class component with enum property types', () => {
            // given
            const component = getImplementation_1.getImplementation('ClassEnumTypes');
            const expectedMetadata = {
                defaultExported: true,
                name: 'ClassEnumTypes',
                properties: [
        ...
        it('serializes class component with default property values', () => {
            // given
            const component = getImplementation_1.getImplementation('ClassWithDefaults');
            const expectedMetadata = {
                defaultExported: true,
        ...
        it('serializes component with shape property type', () => {
            // given
            const component = getImplementation_1.getImplementation('ClassPropShapeType');
            const expectedMetadata = {
                defaultExported: true,
        ...
        it('serializes component with shape property type and a default value for it', () => {
            // given
            const component = getImplementation_1.getImplementation('PropShapeTypeWithDefault');
            const expectedMetadata = {
                defaultExported: true,
        ...
        it('serializes component with Flow property types', () => {
            // given
            const component = getImplementation_1.getImplementation('IntegrationComboFlow');
            const expectedMetadata = {
                defaultExported: true,
        ...
        it('serializes component with imported enum property types', () => {
            // given
            const component = getImplementation_1.getImplementation('FunctionWithImportedEnum');
            const expectedMetadata = {
                defaultExported: true,
        ...
        it('provides warning details for corrupted default property values', () => {
            // given
            const component = getImplementation_1.getImplementation('CorruptedDefaultPropertyValue');
            const expectedMetadata = {
                defaultExported: true,
...
`,
            ...
            // when
            return serializeJSComponent_1.serializeJSComponent(component).then((serialized) => {
                // then
        ...
        it('rejects returned promise when there is no React component in the given file', (done) => {
            // given
            const component = getImplementation_1.getImplementation('FileWithoutComponent');
            // when
            serializeJSComponent_1.serializeJSComponent(component).catch((error) => {
                // then
        ...
        it('rejects returned promise when there is no file at the given path', (done) => {
            // given
            const component = getImplementation_1.getImplementation('NonexistentFile');
            // when
            serializeJSComponent_1.serializeJSComponent(component).catch((error) => {
                // then
        ...
        it('serializes component with number as oneOf', () => {
            // given
            const component = getImplementation_1.getImplementation('PropTypesOneOfNumber');
            const expectedMetadata = {
                defaultExported: true,
...
//# sourceMappingURL=serializeJSComponent.test.js.map