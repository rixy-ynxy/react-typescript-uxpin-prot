...
const getCommentTagInlineValue_1 = require("../getCommentTagInlineValue");
describe('getCommentTagInlineValue', () => {
    const tag = '@uxpintag';
    describe('when comment is empty', () => {
        const comment = '';
        it('returns undefined', () => {
            expect(getCommentTagInlineValue_1.getCommentTagInlineValue(comment, tag)).toBeUndefined();
        });
    });
    ...
    describe('when comment contains given tag with simple value', () => {
        ...
        it('returns tag value', () => {
            expect(getCommentTagInlineValue_1.getCommentTagInlineValue(comment, tag)).toEqual('tagvalue');
        });
    });
    describe('when comment contains given tag with complex value', () => {
        const comment = '@uxpintag tag.value_foo-baz ';
        it('returns tag value', () => {
            expect(getCommentTagInlineValue_1.getCommentTagInlineValue(comment, tag)).toEqual('tag.value_foo-baz');
        });
    });
    describe('when comment contains #', () => {
        const comment = '@uxpintag https://mui.com/components/buttons/#main-content';
        it('returns tag value', () => {
            expect(getCommentTagInlineValue_1.getCommentTagInlineValue(comment, tag)).toEqual('https://mui.com/components/buttons/#main-content');
        });
    });
...
//# sourceMappingURL=getCommentTagInlineValue.test.js.map