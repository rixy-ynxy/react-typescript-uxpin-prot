...
const getPropertyDescription_1 = require("../getPropertyDescription");
describe('getPropertyDescription', () => {
    describe('without custom descriptors', () => {
        it('should return empty string when not provided', () => {
            ...
            // when
            // then
            expect(getPropertyDescription_1.getPropertyDescription(desc)).toEqual('');
        });
        it('should trim description', () => {
            ...
            // when
            // then
            expect(getPropertyDescription_1.getPropertyDescription(desc)).toEqual('Some description');
        });
...
lines.`;
            ...
            // when
            // then
            expect(getPropertyDescription_1.getPropertyDescription(desc)).toEqual(`Some
multiline
description
...
//# sourceMappingURL=getPropertyDescription.test.js.map