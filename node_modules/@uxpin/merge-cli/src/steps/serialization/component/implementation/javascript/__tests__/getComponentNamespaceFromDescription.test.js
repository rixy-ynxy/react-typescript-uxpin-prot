...
describe('getComponentNamespaceFromDescription', () => {
    ...
    describe('when description is empty', () => {
        ...
        it('returns undefined', () => {
            expect(getComponentNamespaceFromDescription_1.getComponentNamespaceFromDescription(componentName, description)).toBeUndefined();
        });
    });
    ...
    describe('when description contains single-line @uxpinnamespace annotation', () => {
        ...
        it('returns namespace name', () => {
            expect(getComponentNamespaceFromDescription_1.getComponentNamespaceFromDescription(componentName, description)).toMatchObject({
...
//# sourceMappingURL=getComponentNamespaceFromDescription.test.js.map